...
static const uint8_t ov2640_settings_rgb565[][2] = {
    ...
    {0xD7, 0x03},
    {0xE1, 0x77},
	//{0x0B, 0x1E}, // CLOCK RATE CONTROL ADDED
    {RESET, 0x00},
    {0, 0},
};
...
// todo: EDITED - added raw 8bit
static const uint8_t ov2640_settings_raw_backup[][2] = {
		{BANK_SEL, BANK_DSP},
		{0xF8,0x01},  // SCCB Master access setting
		{RESET, RESET_DVP}, // RESET DVP
		{0x05, 0x00}, // 0x01 = DSP bypass, 0x00 = DSP, see COM10 for bypass
		//{0xC2, 0x01}, // 0x01 = RAW enable
		//{0x50, 0xCE}, // V_DIVIDER, H_DIVDER ?
		//{IMAGE_MODE, IMAGE_MODE_RAW},
		{IMAGE_MODE, 0x04}, // 0x04 = RAW10 high byte first, 0x05 = RAW10 low byte first
		{0xD7, 0x03},     // ??
		{0xE1, 0x77},     // ??
		{REG32, 0x03},    // PCLK DIVIDER (0x03 -> divide by 4, 0x02 -> divide by 2)
		{R_DVP_SP, 0x02}, // DVP OUTPUT SPEED CONTROL 0x01
		{RESET, 0x00},    // ZERO RESET REG
		{0, 0},
};

static const uint8_t ov2640_settings_raw[][2] = {
		{BANK_SEL, BANK_DSP},// Select DSP BANK
		{0xF8,0x01},  		// SCCB Master access setting
		{RESET, RESET_DVP}, // RESET DVP
		{0x05, 0x00},	    // 0x01 = DSP bypass, 0x00 = DSP, see COM10 for bypass
		{IMAGE_MODE, 0x04}, // 0x04 = RAW10 high byte first, 0x05 = RAW10 low byte first

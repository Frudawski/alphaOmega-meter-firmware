...
// THE ORIGINAL EXAMPLE SOFTWARE "blehr main.c" FROM ESPRESSIF ESP-IDF V4.4.3 WAS CHANGED BY FREDERIC RUDAWSKI
...
static xTimerHandle ble_tx_timer;

static bool notify_state;

static uint16_t conn_handle;

static const char *device_name = "ao-meter";
...
void aometer_setup_ble_server(void)
{
    int rc;
    ...
    ble_tx_timer = xTimerCreate("ble_tx_timer", pdMS_TO_TICKS(1000), pdTRUE, (void *)0, ble_tx_data);
